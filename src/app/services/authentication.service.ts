...
export class AuthenticationService {
  ...
  constructor(private http: Http, private authHttp: AuthHttpService, private jwtHelper: JwtHelper, private router: Router) {
  ...
  public startupTokenRefresh() {
    ...
    if(!tokenNotExpired(null, localStorage.getItem('refresh_token'))) {
      return;
    }
